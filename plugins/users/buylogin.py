...
async def comprar_logins_list(c: Client, m: CallbackQuery):
    ...
    await m.edit_message_text(
        f"""<a href='https://i.ibb.co/r0jsL20/IMG-20230712-135120-982.jpg'>&#8204</a><b>🎟️ Comprar Logins</b>
...
async def comprar_logins(c: Client, m: CallbackQuery):
    ...
    total = f"<b>Logins No Estoque</b>: {sum([int(x[1]) for x in logins])}" if logins else ""
    ...
    await m.edit_message_text(
        f"""<a href='https://i.ibb.co/r0jsL20/IMG-20230712-135120-982.jpg'>&#8204</a><b>🎟 Comprar Logins Unitário</b>
...
async def buy_off_logins(c: Client, m: CallbackQuery):
    ...
    kb = InlineKeyboardMarkup(
                    inline_keyboard=[
                        [
                            InlineKeyboardButton(
                                text="🎟 Compre os melhores Logins",url=f"https://t.me/NuckyStoreBot"
                            ),
                        ],
                    ]
                )
