...
<b>├💸 Saldo: R${}</b>
<b>└💎 Pontos: R${}</b>
<b>🥇 Bônus de Recarga: <i>Desativado</i></b>"""
    rt = cur.execute(
...
async def msg_buy_user(
    ...
    base = f"""<b>💳 COMPRA EFETUADA COM SUCESSO!</b>
...
def msg_group_publico_logins(
    ...
    produto = f"""<a href='https://ibb.co/8gJRrXb'</a><b>🎉</b>+1 LOGIN VENDIDO COM SUCESSO!</b>
...
def msg_group_publico_contas(
    ...
    produto = f"""<a href='https://t.me/{BOT_LINK}'>&#8204</a><b>🎉</b>+1 CONTA PREMIUM VENDIDA!</b>
...
def msg_group_publico_vale(
    ...
    produto = f"""<a href='https://t.me/{BOT_LINK}'>&#8204</a><b>🎉</b>+1 VALE VENDIDO COM SUCESSO!</b>
...
def msg_group_pub_doc(
    ...
    produto = f"""<a href='https://i.ibb.co/jyDBWmF/images.jpg'</a><b>🎉 </b>+1 {tipo} VENDIDO COM SUCESSO!</b>
...
def msg_group_publico(
    ...
    produto = f"""<a href='https://i.ibb.co/bJgz6Ly/IMG-20230711-113223-015.jpg'>&#8204</a><b>💳</b>+1 VENDA EFETUADA COM SUCESSO!</b>
...
def msg_group_publico_full(
    ...
    produto = f"""<a href='https://ibb.co/NCY4ZLG'>&#8204</a><b>💳 </b>+1 FULL DADOS VENDIDA COM SUCESSO!</b>
...
def msg_group_publico_consul(
    ...
    produto = f"""<a href='https://ibb.co/NCY4ZLG'>&#8204</a><b>💳 </b>+1 CONSULTAVEL VENDIDA COM SUCESSO!</b>
