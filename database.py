...
CREATE TABLE IF NOT EXISTS bot_config(
    ...
    main_img TEXT DEFAULT 'https://i.ibb.co/Tvvg8yh/banner-psd-reizintramposs-1.png',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@LittleNucky',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@RefsLittleNucky',                                    -- Canal de notícias
